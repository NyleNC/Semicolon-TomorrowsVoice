...
namespace TomorrowsVoices.Data
{
    public static class TomorrowsVoicesInitializer
    {
        ...
        new Volunteer { FirstName = "John", LastName = "Doe", Phone = "1234567890", Email = "john.doe@gmail.com", Status = ApprovalStatus.Approved, VolLocationID = context.VolLocations.FirstOrDefault(v => v.City == "Niagara Falls")?.ID ?? 0 },
        new Volunteer { FirstName = "Jane", LastName = "Smith", Phone = "2345678901", Email = "jane.smith@outlook.com", Status = ApprovalStatus.Approved, VolLocationID = context.VolLocations.FirstOrDefault(v => v.City == "Niagara Falls")?.ID ?? 0 },
        new Volunteer { FirstName = "Alice", LastName = "Johnson", Phone = "3456789012", Email = "alice.johnson@yahoo.com", Status = ApprovalStatus.Approved, VolLocationID = context.VolLocations.FirstOrDefault(v => v.City == "Niagara Falls")?.ID ?? 0 },
        new Volunteer { FirstName = "Bob", LastName = "Brown", Phone = "4567890123", Email = "bob.brown@tv.com", Status = ApprovalStatus.Approved, VolLocationID = context.VolLocations.FirstOrDefault(v => v.City == "Toronto")?.ID ?? 0 },
        new Volunteer { FirstName = "Charlie", LastName = "Davis", Phone = "5678901234", Email = "charlie.davis@gmail.com", Status = ApprovalStatus.Approved, VolLocationID = context.VolLocations.FirstOrDefault(v => v.City == "Niagara Falls")?.ID ?? 0 },
        new Volunteer { FirstName = "David", LastName = "Miller", Phone = "6789012345", Email = "david.miller@outlook.com", Status = ApprovalStatus.Approved, VolLocationID = context.VolLocations.FirstOrDefault(v => v.City == "Toronto")?.ID ?? 0 },
        new Volunteer { FirstName = "Eve", LastName = "Wilson", Phone = "7890123456", Email = "eve.wilson@yahoo.com", Status = ApprovalStatus.Approved, VolLocationID = context.VolLocations.FirstOrDefault(v => v.City == "Niagara Falls")?.ID ?? 0 },
        new Volunteer { FirstName = "Frank", LastName = "Moore", Phone = "8901234567", Email = "frank.moore@tv.com", Status = ApprovalStatus.Approved, VolLocationID = context.VolLocations.FirstOrDefault(v => v.City == "Niagara Falls")?.ID ?? 0 },
        new Volunteer { FirstName = "Grace", LastName = "Taylor", Phone = "9012345678", Email = "grace.taylor@gmail.com", Status = ApprovalStatus.Approved, VolLocationID = context.VolLocations.FirstOrDefault(v => v.City == "Niagara Falls")?.ID ?? 0 },
        new Volunteer { FirstName = "Hank", LastName = "Anderson", Phone = "0123456789", Email = "hank.anderson@outlook.com", Status = ApprovalStatus.Approved, VolLocationID = context.VolLocations.FirstOrDefault(v => v.City == "Niagara Falls")?.ID ?? 0 },
        new Volunteer { FirstName = "Ivy", LastName = "Thomas", Phone = "1122334455", Email = "ivy.thomas@yahoo.com", Status = ApprovalStatus.Approved, VolLocationID = context.VolLocations.FirstOrDefault(v => v.City == "Toronto")?.ID ?? 0 },
        new Volunteer { FirstName = "Jack", LastName = "Jackson", Phone = "2233445566", Email = "jack.jackson@tv.com", Status = ApprovalStatus.Approved, VolLocationID = context.VolLocations.FirstOrDefault(v => v.City == "Toronto")?.ID ?? 0 },
        new Volunteer { FirstName = "Karen", LastName = "White", Phone = "3344556677", Email = "karen.white@gmail.com", Status = ApprovalStatus.Approved, VolLocationID = context.VolLocations.FirstOrDefault(v => v.City == "Toronto")?.ID ?? 0 },
        new Volunteer { FirstName = "Leo", LastName = "Harris", Phone = "4455667788", Email = "leo.harris@outlook.com", Status = ApprovalStatus.Approved, VolLocationID = context.VolLocations.FirstOrDefault(v => v.City == "Niagara Falls")?.ID ?? 0 },
        new Volunteer { FirstName = "Mia", LastName = "Martin", Phone = "5566778899", Email = "mia.martin@yahoo.com", Status = ApprovalStatus.Approved, VolLocationID = context.VolLocations.FirstOrDefault(v => v.City == "Toronto")?.ID ?? 0 },
        new Volunteer { FirstName = "Nina", LastName = "Thompson", Phone = "6677889900", Email = "nina.thompson@tv.com", Status = ApprovalStatus.Approved, VolLocationID = context.VolLocations.FirstOrDefault(v => v.City == "Niagara Falls")?.ID ?? 0 },
        new Volunteer { FirstName = "Oscar", LastName = "Garcia", Phone = "7788990011", Email = "oscar.garcia@gmail.com", Status = ApprovalStatus.Approved, VolLocationID = context.VolLocations.FirstOrDefault(v => v.City == "Toronto")?.ID ?? 0 },
        new Volunteer { FirstName = "Paul", LastName = "Martinez", Phone = "8899001122", Email = "paul.martinez@outlook.com", Status = ApprovalStatus.Approved, VolLocationID = context.VolLocations.FirstOrDefault(v => v.City == "Niagara Falls")?.ID ?? 0 },
        new Volunteer { FirstName = "Quinn", LastName = "Robinson", Phone = "9900112233", Email = "quinn.robinson@yahoo.com", Status = ApprovalStatus.Approved, VolLocationID = context.VolLocations.FirstOrDefault(v => v.City == "Niagara Falls")?.ID ?? 0 },
        new Volunteer { FirstName = "Rose", LastName = "Clark", Phone = "0011223344", Email = "rose.clark@tv.com", Status = ApprovalStatus.Approved, VolLocationID = context.VolLocations.FirstOrDefault(v => v.City == "Niagara Falls")?.ID ?? 0 },
        new Volunteer { FirstName = "Sam", LastName = "Rodriguez", Phone = "1029384756", Email = "sam.rodriguez@gmail.com", Status = ApprovalStatus.Approved, VolLocationID = context.VolLocations.FirstOrDefault(v => v.City == "Niagara Falls")?.ID ?? 0 },
        new Volunteer { FirstName = "Tina", LastName = "Lewis", Phone = "5647382910", Email = "tina.lewis@outlook.com", Status = ApprovalStatus.Approved, VolLocationID = context.VolLocations.FirstOrDefault(v => v.City == "Toronto")?.ID ?? 0 },
        new Volunteer { FirstName = "Uma", LastName = "Lee", Phone = "9876543210", Email = "uma.lee@yahoo.com", Status = ApprovalStatus.Approved, VolLocationID = context.VolLocations.FirstOrDefault(v => v.City == "Niagara Falls")?.ID ?? 0 },
        new Volunteer { FirstName = "Vince", LastName = "Walker", Phone = "1357924680", Email = "vince.walker@tv.com", Status = ApprovalStatus.Approved, VolLocationID = context.VolLocations.FirstOrDefault(v => v.City == "Niagara Falls")?.ID ?? 0 },
        new Volunteer { FirstName = "Wendy", LastName = "Hall", Phone = "2468013579", Email = "wendy.hall@gmail.com", Status = ApprovalStatus.Approved, VolLocationID = context.VolLocations.FirstOrDefault(v => v.City == "Niagara Falls")?.ID ?? 0 }
    );
                context.SaveChanges();
            }
        }

        ...
        private static void SeedEvents(TomorrowsVoicesContext context)
        {
            if (!context.Events.Any())
            {
                context.Events.AddRange(
                    ...
                    new Event { Name = "Blood Donation Camp", Description = "A blood donation camp.", StartTime = DateTime.Parse("2024-04-05 08:00"), EndTime = DateTime.Parse("2024-04-05 18:30"), VolLocationID = context.VolLocations.FirstOrDefault(v => v.City == "Toronto").ID }
                );
                context.SaveChanges();
            }
        }
